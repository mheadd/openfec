...
exports.communicationCosts = function (params, callback) {
	var path = '/committee/' + params.commitee_id + '/communication_costs/by_candidate/';
	delete params.commitee_id;
    client.makeApiCall(path, params, callback);
};

exports.electioneeringCosts = function (params, callback) {
	var path = '/committee/' + params.commitee_id + '/electioneering_costs/by_candidate/';
	delete params.commitee_id;
    client.makeApiCall(path, params, callback);
};